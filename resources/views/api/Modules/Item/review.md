##Plenty\Modules\Item\Attribute\Contracts\AttributeRepositoryContract
...
Für die Methode `create` fehlt die Beschreibung.

Für die Methode `show` fehlt die Beschreibung.

Für die Methode `update` fehlt die Beschreibung.

Für die Methode `delete` fehlt die Beschreibung.

Für die Methode `findById` fehlt die Beschreibung.

Für die Methode `all` fehlt die Beschreibung.

##Plenty\Modules\Item\Attribute\Contracts\AttributeValueRepositoryContract
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für die Methode `findByAttributeId` fehlt die Beschreibung.
...
Für das Property `tracdelightValue` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).
...
##Plenty\Modules\Item\Barcode\Contracts\BarcodeRepositoryContract
Beschreibung ist zu kurz oder nicht vorhanden:
...
##Plenty\Modules\Item\Barcode\Models\Barcode
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für das Property `referrerlinks` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

###Methoden

Alles gut. :)

##Plenty\Modules\Item\Barcode\Models\BarcodeLinkReferrer
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für das Property `barcode` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).
...
Für das Property `reader` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `totalCount` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `resultIdsList` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `pointer` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).
...
##Plenty\Modules\Item\Item\Models\Item
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für das Property `texts` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

###Methoden

Für die Methode `texts` fehlt die Beschreibung.

Für die Methode `variations` fehlt die Beschreibung.
...
##Plenty\Modules\Item\Unit\Contracts\UnitRepositoryContract
###Properties
...
##Plenty\Modules\Item\VariationImage\Contracts\VariationImageRepositoryContract
Beschreibung ist zu kurz oder nicht vorhanden:
...
##Plenty\Modules\Item\VariationImage\Models\VariationImage
###Properties
...
##Plenty\Modules\Item\Variation\Contracts\VariationRepositoryContract
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für die Methode `createPrimary` fehlt die Beschreibung.

Für die Methode `delete` fehlt die Beschreibung.

Für die Methode `findById` fehlt die Beschreibung.

##Plenty\Modules\Item\Variation\Models\Variation
Beschreibung ist zu kurz oder nicht vorhanden:
...
Für das Property `automaticClientVisibility` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).
...
Für das Property `priceCalculationSetId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `unitLoadDevice` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `weightNetG` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `variationBarcodes` ist die Beschreibung zu kurz:

    barcodes

Für das Property `variationClients` ist die Beschreibung zu kurz:

    Clients

Für das Property `variationMarkets` ist die Beschreibung zu kurz:

    Markets

Für das Property `variationSuppliers` ist die Beschreibung zu kurz:

    Suppliers

Für das Property `categoryVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `marketVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `clientVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `salesPriceVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `supplierVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).

Für das Property `warehouseVariationId` fehlt die Beschreibung (Evtl. `@inheritdoc` und/oder `@internal`?).
